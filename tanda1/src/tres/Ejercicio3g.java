...
public class Ejercicio3g extends JFrame {
	...
	public Ejercicio3g() {
		...
		JCheckBox checkDiseño = new JCheckBox("Diseño gráfico");
		contentPane.add(checkDiseño);
		
		JCheckBox checkAdministración = new JCheckBox("Administración");
		contentPane.add(checkAdministración);
		
		JCheckBox[] checks = {checkAdministración,checkDiseño,checkProgramacion};
